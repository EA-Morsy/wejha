...
A collection of all city flags in SVG — plus the CSS for easier integration.
...
[ISO 3166-1-alpha-2 code](http://www.iso.org/iso/city_names_and_code_elements)
of a city) to an empty `<span>`. If you want to have a squared version flag
...
To have only specific cities in the css file, remove the ones that you don't
need from the
